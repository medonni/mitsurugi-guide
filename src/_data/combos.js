  ...
  lines: [
    {
      ...
      steps: [
        ...
        { n: "2.5", card: "Tributed monsters trigger", do: "Kusanagi returns Mitsurugi Ritual to hand; Aramasa fetches Futsu no Mitama.",
        ...
        { n: "6.5", card: "Set the Trap", do: "Set Mitsurugi Great Purification to finish." },
      ],
    },
    {
      id: "main-2",
      ...
      section: "1 Card Combos",
      tag: "Aramasa opener",
      starter: 'An opener that lands an <a href="../cards/#aramasa">Aramasa</a> Normal Summon.',
      result: "Habakiri, Murakumo, and Futsu no Mitama on board, plus a Rank 4 Xyz or Link 2 of your choice and a set Mitsurugi Great Purification",
      steps: [
        ...
        { n: "2.5", card: "Habakiri triggers in GY", do: "As Prayers hits the GY, Habakiri's GY effect adds Mitsurugi Ritual to hand. Unfortunately, we cannot revive Habakiri here as it was not properly summoned first." },
        ...
        { n: "5.5", card: "Futsu + Mirror trigger in GY", do: "Futsu revives itself from the GY in defense; then Mirror's GY effect shuffles Mirror back and adds Mitsurugi Great Purification.",
          why: "You get the Futsu wall back and end on a live Trap." },
        { n: "6", card: "Flexible Extra Deck end", do: "Keep the Level 8 ritual monsters on board and overlay only the two Level 4 Mikotos (Saji and Aramasa) into any Rank 4 Xyz of your choice, or use them for a Link 2.",
          why: "The Level 8 bodies (Habakiri, Murakumo, the 3400 Futsu wall) are already your board, so spend just the disposable Level 4s on the Extra Deck play." },
        { n: "6.5", card: "Set the Trap", do: "Set Mitsurugi Great Purification to finish." },
      ],
    },
    {
      ...
      steps: [
        { n: "0", card: "Open on Prayers", do: "Activate Mitsurugi Prayers to add Habakiri to hand, then let Prayers hit the GY.",
        ...
        { n: "5", card: "Extra Deck end", do: "Do not overlay into a Rank 8. Keep the three Level 8 walls; if you want an Extra Deck body, make a Link 2 off two of them.",
          why: "This line has no leftover Level 4 Mikotos, so a Rank 4 isn't available. Prayers as your only starter pays off in three big Level 8 bodies instead of an Extra Deck piece." },
        { n: "5.5", card: "Set the Trap", do: "Set Mitsurugi Great Purification to finish." },
      ],
    },
    {
      id: "main-4",
      ...
      section: "1 Card Combos",
      tag: "Pre-Prep opener",
      starter: 'A lone <a href="../cards/#preprep">Pre-Preparation of Rites</a>',
      result: "Habakiri, Murakumo, and Futsu no Mitama on board, plus a Rank 4 Xyz or Link 2 of your choice, a set Mitsurugi Great Purification, and a spare Prayers in hand",
      steps: [
